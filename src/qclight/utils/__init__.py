...
from qclight.error import BinaryStringError
...
def extract_bits(number: "int", idx: "int | list[int]") -> "int":
    ...
    in the order they appear in the list, little endian.
    ...
    Args:
        ...
        idx: index or list of indexes of the bits to extract, little endian
